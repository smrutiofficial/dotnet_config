...
local lsp_servers = {
  ...
  jdtls = {
    ...
    root_dir = function(fname)
      -- Look for .git or a specific project marker file/folder
      local util = require("lspconfig.util")
      return util.root_pattern(".git", "pom.xml", "build.gradle")(fname) or util.root_pattern(".project_marker")(fname) -- Replace with your custom marker
    end,
    settings = {
      java = {
        format = {
